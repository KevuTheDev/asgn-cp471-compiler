...
namespace compiler
{
    ...
    const uint8_t COMPILER_FILE_EXTENSION_MAIN_LEN = COMPILER_FILE_EXTENSION_MAIN.length();
    const uint8_t COMPILER_FILE_EXTENSION_TOKEN_LEN = COMPILER_FILE_EXTENSION_TOKEN.length();
    const uint8_t COMPILER_FILE_EXTENSION_LOG_LEN = COMPILER_FILE_EXTENSION_LOG.length();
